...
<div id="comments" class="content-wrap" itemscope itemtype="http://schema.org/Comment">
	...
	<?php
		...
		array(
			'comment_notes_after' => '',
			'comment_field' => '<div class="comment-form-comment form-group"><label class="control-label" for="comment">' . __( 'Comment', 'odin' ) . '</label><div class="controls"><textarea id="comment" name="comment " cols="45" rows="8" class="materialize-textarea" aria-required="true"></textarea></div></div>',
